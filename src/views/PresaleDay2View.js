...
const scripts = [
  ...
  { loading: fetch("https://uploads-ssl.webflow.com/6165507cab3fc14387e2119a/618513ebaace2c8bdd8c2067_web3_day2.txt").then(body => body.text()), isAsync: false },
]

let Controller

class PresaleDay2View extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('..\controllers/PresaleDay2Controller')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '61828ba571ff834b3764be43'
  ...
  render() {
    const proxies = PresaleDay2View.Controller !== PresaleDay2View ? transformProxies(this.props.children) : {
            ...
            <div className="af-class-section-copy af-class-wf-section">
              <div className="af-class-container w-container">
                <div className="af-class-div-block-5">
                  <h1 className="af-class-heading">Presale Day2 LAUNCH IN</h1>
                </div>
                ...
                <div className="af-class-mint">
                  ...
                  <div data-w-id="a16bcf54-37e2-0f8d-b49e-2e8d9f7a8826" style={{opacity: '0.6'}} className="af-class-mint-button">
                    <div className="af-class-html-embed-2 w-embed">
                      <div style={{cursor: 'pointer'}} onclick="_premintd2(2)"><span className="af-class-showAlert">MiNT my 2 DemiHuman <br />♀ 0.16 ETH ♀ </span></div>
                    </div>
                  </div>
                  <div data-w-id="e7661ef5-0fde-69ac-79de-146cd21c39bb" style={{opacity: '0.6'}} className="af-class-mint-button">
                    <div className="af-class-html-embed-2 w-embed">
                      <div style={{cursor: 'pointer'}} onclick="_premintd2(1)"><span className="af-class-showAlert2">MiNT my 1 DemiHuman <br />♀ 0.08 ETH ♀ </span></div>
                    </div>
                  </div>
                </div>
              </div>
...
export default PresaleDay2View
