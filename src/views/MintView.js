...
class MintView extends React.Component {
  static get Controller() {
    ...
    try {
      Controller = require('..\controllers/MintController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '61828ba571ff839e2764be3f'
  ...
  render() {
    const proxies = MintView.Controller !== MintView ? transformProxies(this.props.children) : {
            ...
            <div className="af-class-section-copy af-class-wf-section">
              <div className="af-class-container w-container">
                <div className="af-class-div-block-5">
                  <h1 className="af-class-heading">PUBLIC SALE Ends IN</h1>
                </div>
              ...
              </div><img src="images/FOMO.jpeg" loading="lazy" sizes="100vw" srcSet="images/FOMO-p-500.jpeg 500w, images/FOMO-p-1080.jpeg 1080w, images/FOMO-p-1600.jpeg 1600w, images/FOMO.jpeg 1971w" alt />
            </div>
            <div className="af-class-section-demi af-class-wf-section">
              <div className="af-class-mint-block w-clearfix">
                <div className="af-class-mint">
                  ...
                  <div data-w-id="a16bcf54-37e2-0f8d-b49e-2e8d9f7a8826" style={{opacity: '0.6'}} className="af-class-mint-qty">
                    <div className="af-class-html-embed-text w-embed">
                      <form id="myform" method="POST" action="#">
                        <label htmlFor> </label><input type="button" defaultValue="-" className="af-class-qtyminus" field="quantity" />
                        {/* 
             */} <input type="text" name="quantity" defaultValue={0} className="af-class-qty" id="qty3" />
                        {/* 
         */}<input type="button" defaultValue="+" className="af-class-qtyplus" field="quantity" />
                      </form>
                    </div>
                  </div>
                  <div data-w-id="e7661ef5-0fde-69ac-79de-146cd21c39bb" style={{opacity: '0.6'}} className="af-class-mint-button">
                    <div className="af-class-html-embed-2 w-embed">
                      <div style={{cursor: 'pointer'}} onclick="_publicmint()"><span className="af-class-showAlert">♀ MiNT ♀</span></div>
                    </div>
                  </div>
                </div>
              </div>
