...
class CheckoutView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '620bcd3d5054d744dafb03df'
              ...
              <div className="w-commerce-commercelayoutcontainer w-container">
                <div className="w-commerce-commercelayoutmain">
                  <div data-node-type="commerce-cart-quick-checkout-actions">
                    <a role="button" tabIndex={0} aria-haspopup="dialog" aria-label="Apple Pay" data-node-type="commerce-cart-apple-pay-button" style={{backgroundImage: '-webkit-named-image(apple-pay-logo-white)', backgroundSize: '100% 50%', backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat'}} className="w-commerce-commercecartapplepaybutton">
                      <div />
                    </a>
                    <a role="button" tabIndex={0} aria-haspopup="dialog" data-node-type="commerce-cart-quick-checkout-button" style={{display: 'none'}} className="w-commerce-commercecartquickcheckoutbutton"><svg className="w-commerce-commercequickcheckoutgoogleicon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={16} height={16} viewBox="0 0 16 16">
                        <defs>
                  ...
                  <form data-node-type="commerce-checkout-customer-info-wrapper" className="w-commerce-commercecheckoutcustomerinfowrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Email *</label><input type="text" className="w-commerce-commercecheckoutemailinput" name="email" required /></fieldset>
                  </form>
                  <form data-node-type="commerce-checkout-shipping-address-wrapper" className="w-commerce-commercecheckoutshippingaddresswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" className="w-commerce-commercecheckoutshippingfullname" name="name" required /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" className="w-commerce-commercecheckoutshippingstreetaddress" name="address_line1" required /><input type="text" className="w-commerce-commercecheckoutshippingstreetaddressoptional" name="address_line2" />
                      <div className="w-commerce-commercecheckoutrow">
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">City *</label><input type="text" className="w-commerce-commercecheckoutshippingcity" name="address_city" required /></div>
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" className="w-commerce-commercecheckoutshippingstateprovince" name="address_state" /></div>
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" data-node-type="commerce-checkout-shipping-zip-field" className="w-commerce-commercecheckoutshippingzippostalcode" name="address_zip" required /></div>
                      </div><label className="w-commerce-commercecheckoutlabel">Country *</label><select className="w-commerce-commercecheckoutshippingcountryselector" name="address_country">
                  ...
                  <form data-node-type="commerce-checkout-shipping-methods-wrapper" className="w-commerce-commercecheckoutshippingmethodswrapper">
                    ...
                    <fieldset>
                      <div data-node-type="commerce-checkout-shipping-methods-list" className="w-commerce-commercecheckoutshippingmethodslist" data-wf-collection="database.commerceOrder.availableShippingMethods" data-wf-template-id="wf-template-620bcd3d5054d7f345fb03e0000000000042"><label className="w-commerce-commercecheckoutshippingmethoditem"><input type="radio" required name="shipping-method-choice" />
                  ...
                  <form data-node-type="commerce-checkout-billing-address-wrapper" style={{display: 'none'}} className="w-commerce-commercecheckoutbillingaddresswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" className="w-commerce-commercecheckoutbillingfullname" name="name" required /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" className="w-commerce-commercecheckoutbillingstreetaddress" name="address_line1" required /><input type="text" className="w-commerce-commercecheckoutbillingstreetaddressoptional" name="address_line2" />
                      <div className="w-commerce-commercecheckoutrow">
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">City *</label><input type="text" className="w-commerce-commercecheckoutbillingcity" name="address_city" required /></div>
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" className="w-commerce-commercecheckoutbillingstateprovince" name="address_state" /></div>
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" data-node-type="commerce-checkout-billing-zip-field" className="w-commerce-commercecheckoutbillingzippostalcode" name="address_zip" required /></div>
                      </div><label className="w-commerce-commercecheckoutlabel">Country *</label><select className="w-commerce-commercecheckoutbillingcountryselector" name="address_country">
                        <option value="AF">Afghanistan</option>
                        <option value="AX">Aland Islands</option>
                        <option value="AL">Albania</option>
                        <option value="DZ">Algeria</option>
                  ...
                  <div className="w-commerce-commercecheckoutorderitemswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent">
                      <div role="list" className="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-620bcd3d5054d7f345fb03e0000000000086" />
                    </fieldset>
                  </div>
                </div>
                <div className="w-commerce-commercelayoutsidebar">
                  <div className="w-commerce-commercecheckoutordersummarywrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent">
                      ...
                      <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-620bcd3d5054d7f345fb03e00000000000a0">
