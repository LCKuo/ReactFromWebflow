...
const scripts = [
  ...
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Exo:100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic","Oswald:200,300,400,500,600,700","Lato:100,100italic,300,300italic,400,400italic,700,700italic,900,900italic","Great Vibes:400","Inter:regular,600","DM Serif Display:regular","Nanum Brush Script:regular"]}});',
    isAsync: false,
  },
  {
    type: 'code',
  ...
  {
    type: 'code',
    body: 'function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-4KS1NJQ3VG",{anonymize_ip:!1});',
    isAsync: false,
  },
  {
    type: 'src',
    body: 'https://www.google.com/recaptcha/api.js',
    isAsync: false,
  },
  {
    type: 'src',
    body: 'https://uploads-ssl.webflow.com/616004d72025acdf09e63dd4/61644994a0ad3f3cb9f93306_web3.txt',
    isAsync: false,
  },
]
